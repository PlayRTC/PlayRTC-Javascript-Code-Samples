...
//                           console.log("_stateChange state:"+state+", cId:"+this.getChannelId());
//                           this.getPeerList(this.getChannelId, function(data){
//                                       console.log("length : "+data.peers.length);
//                                       }, function(a, b){
//                                       
//                                       }
//                                       );
...
//                        console.log("abcdeee state:"+state);
//                        
//                        this.playRtc.getPeerList(this.channelId, function(data){
//                                                 console.log("abcdeee ok :"+data.peers.length);
//                                                 }, function(xhr, res){
//                                                 console.log("abcdeee error : "+res);
//                                                 })
	},
	destroy: function(){
		Logger.warn("cdm", {
...
//                                  PlayRTC.getPeerList(this.getChannelId, function(data){
//                                                   console.log("abcdedf:"+data.peers);
//                                                   }, function(xhr, res){
//                                                   //error
//                                              console.log("abcdedf error:"+res);
//                                                   });
...
//                                  console.log("abcd start");
//                                  printTime();
                                  
//                                  var repeat = 'testabcd('+this.call+')';
//                                  setTimeout(repeat, 3000);
//                                  setTimeout(function(this.call){
//                                  setTimeout("testabcd('"+this.call+"')", 3000);
//                                  setTimeout("testabcd("+this.call+")", 3000);
                                  setTimeout(function(call){testabcd(call);}, 1000, this.call);

//                                  var ccaall = this.call;
//                                  setTimeout(function(ccaall){testabcd(ccaall);}, 3000);
//console.log("abcd end");
                                  
//                                  call.playRtc.getPeerList(call.channelId, function(data){
//                                                                console.log("abcdeok : "+data.peers.length);
//                                                                
//                                                                document.getElementById("text_abc").innerHTML="참여인원수:"+data.peers.length;
//                                                                
//                                                                }, function(xhr, res){
//                                                                console.log("abcderror : "+res);
//                                                                });
//                                             ,3000);
...
//                                  console.log("abcd end : ");}
   ...
   function testabcd(call){
//   console.log("abcd end : "+call.getChannelId());
//   printTime();
   //                                  call.playRtc.getPeerList(call.channelId, function(data){
   //                                                           console.log("abcdeok : "+data.peers.length);
   //
...
//                            console.log("aaaaaa"+data.peers[i].id);
//                            
////                            var peer = call.playRtc.getPeerByPeerId(data.peers[i].id);
////                            console.log("id "+peer.id);
////                            console.log("uid "+peer.uid);
...
//                            }
                                ...
                                console.log("abcderror : "+res);
                                document.getElementById("text_abc").innerHTML="참여인원수:-";
                            });
...
var Rest = {
   /* 1기존코드 : url: "https://apis.sktelecom.com/v3/playrtc", */
   /* 2기존코드 : url: "https://osdf.devcenter.com/v3/playrtc", */
   /* 2기존코드 : 	url: "https://211.188.236.67/v3/playrtc", */
url: "http://osdf.devcenter.com/v3/playrtc",
	projectKey: "60ba608a-e228-4530-8711-fa38004719c1",
	setUrl: function(url){
		this.url = url;
	},
